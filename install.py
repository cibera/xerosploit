...
""")
	...
	if system0 == "1":
		...
		install = os.system("apt-get update && apt-get install -y nmap hping3 build-essential python3-pip3 ruby-dev git libpcap-dev libgmp3-dev && pip3 install tabulate terminaltables")
